...
## Languages
<p style="flex-wrap: wrap; display: flex; gap: 10px;">
...
# Connect with Me
<div align="center" style="margin-top: 20px; display: flex; flex-direction: row; gap: 10px; flex-wrap: wrap; justify-content: center;">
